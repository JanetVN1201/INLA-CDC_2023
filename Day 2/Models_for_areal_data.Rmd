...
```{r code esmail}
setwd("~/Documents/KAUST/clean-data-sets/brazil/fbesag/data2")
...
baseformula <- Y ~ 1 + f(S1,model="generic0", Cmatrix= scaled_graph, constr= TRUE, rankdef = 1,hyper = precision.prior) +
                       ...
                       # f(c_S1,model="generic0", Cmatrix= diag(558), hyper = precision.prior) +
                       # f(c_T1,model="generic0", Cmatrix= diag(12), hyper = precision.prior)
