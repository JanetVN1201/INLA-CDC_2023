...
pAge <- ggplot(data.frame(. ), aes(x=x, y=y)) + geom_line() + 
  labs(x = expression(beta["Age"]), y = "Density") + 
  geom_vline(xintercept = 0, col = "blue")

pSex <- ggplot(data.frame(. ), aes(x=x, y=y)) + geom_line() + 
  labs(x = expression(beta["Sex = 1"]), y = "Density") + 
  geom_vline(xintercept = 0, col = "blue")

pYear <- ggplot(data.frame(. ), aes(x=x, y=y)) + geom_line() + 
  labs(x = expression(beta["Year"]), y = "Density") + 
  geom_vline(xintercept = 0, col = "blue")

pThickness <- ggplot(data.frame(. ), aes(x=x, y=y)) + geom_line() + 
  labs(x = expression(beta["Thickness"]), y = "Density") + 
  geom_vline(xintercept = 0, col = "blue")

pUlcer <- ggplot(data.frame(. ), aes(x=x, y=y)) + geom_line() + 
